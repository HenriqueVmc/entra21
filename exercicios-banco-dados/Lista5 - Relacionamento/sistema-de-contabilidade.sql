...
INSERT INTO ContasPagar(IdCliente, DataVencimento, ValorPago) VALUES 
((SELECT Id FROM Clientes WHERE Nome LIKE 'Germana'), '2018-06-15', 500.00),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Salvador'), '2018-06-29', 320.50),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Úrsula'), '2018-06-07', 450.00),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Aluísio'), '2018-08-27', 1300.00),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Aluísio'), '2018-10-10', 777.00),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Úrsula'), '2018-10-14', 8001.00),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Salvador'), '2018-11-25', 232.12),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Úrsula'), '2018-09-13', 104.23),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Germana'), '2018-06-17', 65.00),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Aluísio'), '2018-10-06', 98.83),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Salvador'), '2018-12-12', 12.17),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Salvador'), '2018-12-23', 6.25);

SELECT * FROM ContasReceber;

INSERT INTO ContasReceber(IdCliente, DataPagamento, ValorRecebido) VALUES
((SELECT Id FROM Clientes WHERE Nome LIKE 'Úrsula'), '2018-12-08', 78.97),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Salvador'), '2018-11-24', 700.00),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Germana'), '2018-10-09', 45.87),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Germana'), '2019-04-01', 39.50),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Aluísio'), '2018-11-30', 123.45),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Úrsula'), '2018-09-07', 987.65),
((SELECT Id FROM Clientes WHERE Nome LIKE 'Salvador'), '2018-07-06', 456.00);
